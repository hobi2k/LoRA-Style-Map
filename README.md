         ...
         └───────────────────┬───────────────┘
           ...
           └───────────────────┬─────────────────┘
                    ...
                    └───────┬──────────┘
                            ...
                            ▼
        ┌───────────────────────────────────────────┐
        │ cluster_labels.csv + cluster_centroids.npy│
        └──────────────┬────────────────────────────┘
                       │
         ┌─────────────────────────────────────────────────┐
...
(단일 LoRA)    (프롬프트 추천)          (주기적 자동 군집)        (UI 서비스)
```
...
│   ├── classify_new_lora.py
│   ├── auto_classify_civitai.py
│   ├── embed_clip_features.py
...
│       └── all/*.jpg
└── scripts/
    ├── download_civitai_data.py
    └── cleanup_corrupted_images.py
